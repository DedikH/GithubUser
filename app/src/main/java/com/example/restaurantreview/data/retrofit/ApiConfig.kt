...
class ApiConfig {
    companion object{
        ...
        fun getApiServiceFavorite(): ApiServiceFavorite {
            val loggingInterceptor =
                HttpLoggingInterceptor().setLevel(HttpLoggingInterceptor.Level.BODY)
            val client = OkHttpClient.Builder()
                .addInterceptor(loggingInterceptor)
        ...
        fun getDetailApiServices(): ApiDetail {
            val loggingInterceptor =
                HttpLoggingInterceptor().setLevel(HttpLoggingInterceptor.Level.BODY)
            val client = OkHttpClient.Builder()
                .addInterceptor(loggingInterceptor)
        ...
        fun getFollowing(): ApiFollowing {
            ...
            val retrofit = Retrofit.Builder()
                ...
                .client(client)
                .build()
            return retrofit.create(ApiFollowing::class.java)
        }

        fun getFollowers(): ApiFollowers {
            val loggingInterceptor =
                HttpLoggingInterceptor().setLevel(HttpLoggingInterceptor.Level.BODY)
            val client = OkHttpClient.Builder()
                .addInterceptor(loggingInterceptor)
